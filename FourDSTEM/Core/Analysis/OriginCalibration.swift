...
enum OriginCalibration {
    ...
    static func probeSize(dp: [Float], qy: Int, qx: Int,
    ...
    static func fitOrigin(measuredX: [Float], measuredY: [Float],
    ...
    private static func fit2D(_ z: [Float], width: Int, height: Int, terms: Int) -> [Float] {
    ...
    private static func solve(_ aIn: [Double], _ bIn: [Double], n: Int) -> [Double]? {
        var a = aIn, b = bIn
        for col in 0..<n {
            // Pivot
            var pivot = col
    ...
    static func run(cube: MTLBuffer, descriptor d: DatasetDescriptor,
                    fitFunction: OriginFitFunction = .plane,

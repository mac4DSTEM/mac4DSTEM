...
| `run-tests.sh unit` | **463 passed / 0 failed / 1 skipped, exit 0 — 2026-09-05, after the review rework**, `scratchpad/unit-20260905.log`, `GATE_EXIT` read from the log's own line. The tree it replaced was RED: the 2026-09-05 manual-scale commit added two assertions its policy could not satisfy and shipped them unrun (`focused-manual-scale-20260905.log`, exit 65). |

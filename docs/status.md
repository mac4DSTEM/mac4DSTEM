...
|---|---|---|
| `run-tests.sh unit` | 441 passed / 0 failed / 3 skipped, exit 0 (the skips: unmounted-volume probe, S17 quarantine, `TB1StallProbeTests` with its staged WS₂ fixture absent). The S17 sidebar intermittent showed 2 of 5 runs on the step 2c tree and 0 of 9 since (`open-items.md`) | 2026-09-03, step 3b-8 tree `02d9317` (retained log) |

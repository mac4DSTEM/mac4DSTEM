...
enum DPC {
    ...
    static func applyRotation(com: [Float], rotationRad: Float, transpose: Bool) -> [Float] {
    ...
    static func magnitudeImage(com: [Float], width: Int, height: Int) -> FloatImage {
        let n = width * height
    ...
    static func angleImage(com: [Float], width: Int, height: Int) -> FloatImage {
        let n = width * height
        var out = [Float](repeating: 0, count: n)
    ...
    static func colorWheelRGBA(com: [Float], width: Int, height: Int) -> RGBAImage {
        let n = width * height
    ...
    static func hsvToRGB(h: Float, s: Float, v: Float) -> (Float, Float, Float) {
    ...
    static func integrateIDPC(com: [Float], width: Int, height: Int,
